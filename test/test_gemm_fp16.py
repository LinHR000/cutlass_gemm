...
bias = torch.ones(n,dtype=torch.float16).cuda()
...
output = gemm_op_int8.gemm_in8_w8_ofp16_per_tensor(input, weight, None,1.0, 0.0, m, n, k,"",3,1)
print(output)

# output = cg_instance.gemm_in8_w8_ofp16_per_tensor_splitk(input, weight, 1.0, 0.0, m, n, k,splitk=2)
# print(output)

print(torch.matmul(input_f,weight_t_half))